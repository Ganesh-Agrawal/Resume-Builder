            ...
            <div>
                <form>
                    ...
                    <div className=" my-2 mx-2">
                        <Link to="/skills" type="submit" id="prevToskill" className="mx-4 btn btn-primary">Previous</Link>
                        <Link to="/viewresume" type="submit" id="nextToview" className="mx-4 btn btn-primary">Create</Link>
                    </div>
                </form>
            </div>
        </div>
